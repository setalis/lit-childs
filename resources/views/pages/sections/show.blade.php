                            ...
                            @if($subsection->practiceBlocks->isNotEmpty())
                                <div class="">
                                    <div class="flex items-center text-gray-600 hover:text-gray-800 mb-4">
                                        ...
                                        <a href="{{ route('blocks.practice.show', [$subsection, $subsection->practiceBlocks->first()]) }}" class="text-gray-600 hover:text-gray-800 transition-colors duration-200 no-underline">
                                    ...
                                    <ul class="ml-8 space-y-1 mb-4">
                                        @foreach($subsection->practiceBlocks->sortBy('order') as $practiceBlock)
                                            <li class="flex items-center">
                                                ...
                                                <a href="{{ route('blocks.practice.show', [$subsection, $practiceBlock]) }}" class="text-gray-800 hover:text-yellow-600 transition-colors duration-200 no-underline">
